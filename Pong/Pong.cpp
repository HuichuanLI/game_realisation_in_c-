...
int main_() {
    //1. 初始化游戏中的数据
    int WIDTH{ 120 }, HEIGHT{ 40 }; //窗口长宽
    int ball_x {WIDTH/2}, ball_y{HEIGHT/2}, ball_vec_x{0}, ball_vec_y{0};
    int paddle_w{4}, paddle_h{10};
    int paddle1_x{0}, paddle1_y{HEIGHT/2-paddle_h/2}, paddle1_vec{3};
    int paddle2_x{ WIDTH - paddle_w }, paddle2_y{ HEIGHT / 2 - paddle_h / 2 }, paddle2_vec{3};
    int score1{ 0 }, score2{ 0 }, score1_x{ paddle_w+8 }, score1_y{ 2 },
            score2_x{ WIDTH- 8- paddle_w }, score2_y{ 2 };
    int pong_circle_r2{40};  //禁区半径的平方
